<script>
	...
	const blog = [
		{
			link: "https://vexcess.github.io/blog/no-to-compelled-speech-and-surveillance",
			name: "NO To Compelled Speech and Surveillance",
			description: "A letter sent to my state representatives."
		},
		{
...
<div class="page crop-center">
	...
	<div class="tooling">
		...
		<div id="proficient">
			{#each proficientSkills as skillInfo}
				<Skill {...skillInfo}/>
			{/each}
		</div>
	</div>
	...
	<div class="tooling">
		...
		<div id="has-experience">
			{#each experienceSkills as skillInfo}
				<Skill {...skillInfo}/>
			{/each}
		</div>
	</div>
